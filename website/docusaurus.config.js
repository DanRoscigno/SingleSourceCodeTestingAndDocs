...
const config = {
  ...
  baseUrl: '/SingleSourceCodeTestingAndDocs/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'DanRoscigno', // Usually your GitHub org/user name.
  projectName: 'SingleSourceCodeTestingAndDocs', // Usually your repo name.
  trailingSlash: false,
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
          'https://github.com/DanRoscigno/SingleSourceCodeTestingAndDocs/blob/main/website/',
        },
        theme: {
